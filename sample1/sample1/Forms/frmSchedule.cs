...
namespace sample1
{
    public partial class frmSchedule : Form
    {
        ...
        private void LoadTransaction()
        {
            ...
            string mysql = "SELECT * FROM RESERVATIONTBL where enddate Between '" + st + "'and '" + en + "' and status <> 'Confirmed'";
            ...
            string mysql1 = "SELECT * FROM transactiontbl where enddate Between '" + st + "'and '" + en + "' and status <> ''";
