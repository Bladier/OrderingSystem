...
namespace sample1
{
    class barangays
    {
        private string MainTable = "barangaytbl";
        ...
        #region "Functions"
        public void loadbarangay(int id)
        {
            ...
            {
                MessageBox.Show("Unable load barangay", "Notification",
    MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        public void LoadByRow(DataRow dr)
        {
            ...
            _barangay = _with3["barangay"].ToString();
            _cityID = Convert.ToInt32(_with3["cityID"]);
